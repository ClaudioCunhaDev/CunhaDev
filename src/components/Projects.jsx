...
export const Projects = () => {
  return (
    <div
      id="projects"
      className="bg-corFundo1 w-full pt-[10vh] pb-3 flex flex-col items-center gap-5 min-[2560px]:h-[100vh] min-[2560px]:pb-0"
    >
      <h2 className="text-blue-500 font-bold text-[1.4rem] 2xl:mb-[5vh] min-[1920px]:text-[2rem]">
        PROJECTS
      </h2>
      <ProjectComponent
        src={coolors}
